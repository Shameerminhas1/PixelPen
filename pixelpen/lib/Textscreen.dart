...
//   void _updateFile(String text) async {
//     if (savedFile != null) {
//       await savedFile!.writeAsString(text);

//       _showSnackBar('File updated successfully');
//     } else {
//       _showSnackBar('No file to update');
//     }
//   }
...
//   void _showSaveOrUpdateDialog() {
//     showDialog(
//       context: context,
//       builder: (BuildContext context) {
//         return AlertDialog(
//           title: Text('Save or Update'),
//           content: Text(
//               'Would you like to save as new or update the existing file?'),
//           actions: <Widget>[
//             TextButton(
...
//             onPressed: _showSaveOrUpdateDialog,
//           ),
//           IconButton(
