...
//             base64Encode(utf8.encode('8989dc74-34c3-11ef-8a36-f2643cf90fba:'))
...
//       var url =
//           'https://app.nanonets.com/api/v2/OCR/Model/5d46b5da-c4bb-4469-a10d-3f18d7a1b19c/LabelFile/?async=true';
...
//         if (message == "Success" && result.isNotEmpty) {
//           var extractedText = result[0]['prediction']
//                   ?.map((pred) => pred['ocr_text'])
//                   .join(' ') ??
//               '';
//           Navigator.push(
//             context,
//             MaterialPageRoute(
//               builder: (context) =>
//                   Textscreen(initialFileContent: extractedText),
//             ),
//           );
//         } else {
//           setState(() {
//             errorMessage = 'OCR failed: ${jsonResponse['message']}';
//           });
//         }
//       } else {
//         setState(() {
//           errorMessage = 'Error performing OCR: ${response.body}';
//         });
//       }
//     } catch (e) {
//       setState(() {
//         errorMessage = 'Error performing OCR: $e';
//       });
//     }
//   }
